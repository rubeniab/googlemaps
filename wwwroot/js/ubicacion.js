...
function distancia(){
    ...
    const selectedMode = document.getElementById("Transporte").ariaValueMax;

    const origin = { lat: latitudHome, lng: longitudHome};
    ...
    if(rutaCheck.checked){
        ...
        .then((response) =>{
            directionsRenderer.setDiretions(response);
        });
    }else{
